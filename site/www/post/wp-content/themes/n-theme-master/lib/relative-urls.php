 ...
 */
function ntheme_root_relative_url($input) {
...
if (ntheme_enable_root_relative_urls()) {
  ...
  add_filters($root_rel_filters, 'ntheme_root_relative_url');
}
